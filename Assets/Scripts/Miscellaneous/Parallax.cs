...
namespace DigitalWorlds.StarterPackage2D
{
    ...
    public class Parallax : MonoBehaviour
    {
        ...
        [Tooltip("Drag in the main SpriteRenderer. The spriteRenderer's width value is used when looping the parallaxing objects.")]
        ...
        private void Start()
        {
            ...
            // Get the spriteRenderer's height and width
        ...
        private void LateUpdate()
        {
            ...
            // Move when the camera reaches half of the spriteRenderer size
